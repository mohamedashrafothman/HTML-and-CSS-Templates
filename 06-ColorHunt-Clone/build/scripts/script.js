...
$(document).ready(function () {
	...
	$('.menu.float-left').on('click', function () {
		$('.secound-level1').slideToggle();
		$('.secound-level2').slideUp();
	});
	$('.menu.float-right').on('click', function () {
		$('.secound-level2').slideToggle();
		$('.secound-level1').slideUp();
	});

	// color span
	$('.card__plate--one>span').on('click', function (e) {
		e.preventDefault();
	});
