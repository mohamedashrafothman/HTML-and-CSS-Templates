		...
		'pug': {
			compile: {
				...
				files: {
					...
					'popular.html': ['src/views/popular.pug'],
					'hot.html': ['src/views/hot.pug'],
					'create.html': ['src/views/create.pug'],
					'color.html': ['src/views/color.pug'],
					'likes.html': ['src/views/likes.pug'],
				}
			},
		},
		'sass': {
